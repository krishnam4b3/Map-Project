...
function AppViewModel() {
    ...
    this.populateInfoWindow = function(marker, infowindow) {
        if (infowindow.marker != marker) {
            ...
            clientID = "TCFCTFPR444L4DLURU3UBAN10LGQ5TDNGY21XR0YNRBBWTOI";
            clientSecret =
                "SXL5CLTNGDPGMINGY5TKSKP01BF3J1FN5MAPMQ1KKZJ2GKQ3";
    ...
    this.initMap = function() {
        ...
        var mapOptions = {
            center: new google.maps.LatLng(16.5449, 81.5212),
            zoom: 16,
            styles: styles,
        };
